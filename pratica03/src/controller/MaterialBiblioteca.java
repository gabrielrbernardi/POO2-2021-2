...
public abstract class MaterialBiblioteca {
	...
	public static Map<Integer, Integer[]> indiceMap = new HashMap<Integer, Integer[]>();  //Id, [tipo, indice]
...
//	public static ArrayList<IndexTemplate> indiceList = new ArrayList<IndexTemplate>();
	...
	public static String print() {
		String str = "";
		try {
			BibliotecaModel.getRegistros();
//			for(Livros livroIterator : livrosList) {
//				System.out.println("Livro: ");
//				System.out.println(livroIterator.getAutor());
//				System.out.println(livroIterator.getTitulo());
//				System.out.println(livroIterator.getAno());
//			}
			...
			e.printStackTrace();
			return "Encerre o programa e tente listar novamente";
		}
		return str;
	}
}
